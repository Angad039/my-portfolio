  ...
  const experienceEntries = [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Log Management: Optimized log forwarding using Splunk to improve monitoring and troubleshooting capabilities. Dynatrace integration for visualization portal monitoring.",
      ],
    },
  ];
